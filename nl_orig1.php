<?php
    ...
    $result1 = mysqli_query($conn, "select time FROM pat_med where time >= now() ORDER BY time ASC Limit 2");
...
<body>
<center>
<h2 style="margin-top: 15%">Food & Medicine Time</h2>
<div style="margin-top: 2%; height: 97px; width: 500px; border: 1px solid #ccc; overflow: auto;" id="box">
    ...
    <div class="row" style="margin-bottom: 1%;">
      ...
      <div class="col-sm-6">
        ...
        <div class="dropdown">
          ...
          <button type="button" class="btn btn-primary dropdown-toggle scroll" style="margin-left: -50%; padding-left: 10%; padding-right: 10%;" data-toggle="dropdown" id="scroll">
            Show Details
          </button>

          <div class="dropdown-menu"><!-- style="height: 97px; border: 1px solid #ccc; overflow: auto;"> -->
            <?php   
            if(!empty($v[$i])){
              $result2 = mysqli_query($conn, "select * FROM pat_med where time = '$v[$i]'");
              while($res2 = mysqli_fetch_row($result2)){?>

                <h5 class="dropdown-header flex-column">Medicine</h5>
                <a class="dropdown-item off"><h6>Medicine: <span class="badge badge-success"><?php echo $res2[3]; ?></span></h6></a>
              ...
              while($res3 = mysqli_fetch_array($result3)){?>
                ...
                <a class="dropdown-item"><h6 style="margin-down: 100px">Food: <span class="badge badge-success"><?php echo $res3[0]; ?></span></h6></a>
...
$('.scroll').click(function(){
    $('#box').animate({height:'310'});
    setTimeout(function () {
    	$('#box').animate({height:'97'});
      $('.off').click();
    }, 5000);
})
</script>
